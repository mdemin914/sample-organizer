...
const Library = ({ folderTree, outputDir }) => ((0, jsx_runtime_1.jsxs)(material_1.Paper, { sx: { flex: 1, minWidth: 0, height: "100%", overflow: "auto", p: 1 }, children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h6", gutterBottom: true, children: "Library" }), outputDir && ((0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "caption", color: "text.secondary", sx: { mb: 1 }, children: outputDir })), (0, jsx_runtime_1.jsx)(TreeView_1.TreeView, { defaultCollapseIcon: (0, jsx_runtime_1.jsx)(ExpandMore_1.default, {}), defaultExpandIcon: (0, jsx_runtime_1.jsx)(ChevronRight_1.default, {}), sx: { flexGrow: 1, overflowY: "auto" }, children: renderTree(folderTree) })] }));
